...
CREATE TABLE IF NOT EXISTS users (
    ...
    private_key VARCHAR(255) NULL, -- Clé privée pour la connexion Wallet (stockage sécurisé à prévoir)
...
CREATE TABLE IF NOT EXISTS donations (
    ...
    sender_address VARCHAR(255) NOT NULL, -- Adresse du donateur
    receiver_address VARCHAR(255) NOT NULL, -- Adresse du bénéficiaire
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS nfts (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    tx_hash VARCHAR(255) NULL UNIQUE -- Hash de la transaction de mint du NFT (optionnel, à remplir après le mint)
);