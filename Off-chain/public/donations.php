...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-card::before {
    ...
    background: radial-gradient(circle, rgba(169, 170, 171, 0.2) 0%, transparent 70%);
    pointer-events: none;
  }
  ...
  <div class="content">
    ...
    <div class="hero-card">
      ...
      <div class="profile-header-card">
        <a href="requestsdonation.php" class="edit-profile-btn" >View donation requests</a>
      </div>
    </div>
    ...
    <div class="form-card">
      ...
      <div class="form-group">
        ...
        <input type="number" id="amount" placeholder="e.g. 10000 ADA">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="date" id="dateLimit" placeholder="e.g. 2026-12-31">
      </div>

      <div class="form-group">
        <label>Benefit of the donation</label>
        <input type="text" id="benefit" placeholder="e.g. This donation will allow...">
      </div>
...
<script>
  document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.getElementById('donationsForm').addEventListener('submit', async (e) => {
      e.preventDefault();
      await zenzeleDonations.submitDonations(amount, motif, dateLimit, benefit);
    });
});
</script>
</body>
