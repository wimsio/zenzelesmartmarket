  ...
  <div class="content">
    ...
    <div class="form-card">
      ...
      <div class="form-group">
        ...
        <input type="number" id="amount" placeholder="Ex: 10000 ada">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="date" id="dateLimit" placeholder="Ex: 2026-12-31">
      </div>

      <div class="form-group">
        <label>Benefit of the donation</label>
        <input type="text" id="benefit" placeholder="Ex: Ce don permettra de ... ">
      </div>
